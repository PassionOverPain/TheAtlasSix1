/** @format */
//The Main function
let playground = document.getElementById("playground"); // The game playground || canvas
...
function closeScroll() {
  ...
  document.getElementById("storyTeller").style.minWidth = "fit-content";
...
function openEncyclopedia(num) {
  ...
  document.getElementById("storyTeller").style.minWidth = "93vw";
  document.getElementById("pgCenter").style.display = "none";
  document.getElementById("heDesc").style.display = `none`;
  document.getElementById("heAttacks").style.display = `none`;
  document.getElementById("heStats").style.display = `none `;
...
function saveGame() {
  const saveData = {
    ...
    arrChoices,
    Encyclopedia,
    background: document.getElementById("playground").style.backgroundImage,
...
function storyEvents(branch) {
  ...
  } else if (branch.event == "playMusic") {
    playMusic(branch.music);
  } else if (branch.event == "stopMusic") {
    stopMusic();
  }
}
